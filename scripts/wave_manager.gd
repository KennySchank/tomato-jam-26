...
@export_range(1.0, 1.5, 0.01) var endless_speed_multiplier_step: float = 1.03
@export_range(1.0, 1.5, 0.01) var endless_health_multiplier_step: float = 1.05
...
@export_range(0.5, 1.0, 0.01) var endless_spawn_interval_factor: float = 0.94
